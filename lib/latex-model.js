...
// ^(?:!%)*\s*
const H1_REGEX = /(^\s*\\part\*?)(\[.*\])?{([^}]*)/;
const H2_REGEX = /(^\s*\\chapter\*?)(\[.*\])?{([^}]*)/;
const H3_REGEX = /(^\s*\\section|frametitle\*?)(\[.*\])?{([^}]*)/;
const H4_REGEX = /(^\s*\\subsection|framesubtitle\*?)(\[.*\])?{([^}]*)/;
const H5_REGEX = /(^\s*\\subsubsection\*?)(\[.*\])?{([^}]*)/;
const H6_REGEX = /(^\s*\\paragraph\*?)(\[.*\])?{([^}]*)/;
const H7_REGEX = /(^\s*\\subparagraph\*?)(\[.*\])?{([^}]*)/;
